...
class Auth
{
    ...
    /**
     * Checked if logined : Authentication
     *
    ...
    static function isLogined(array $args = [], $redirect_again_to = null)
    {
        ...
        $args['session'] = !$args['session'] ? 'auth' : $args['session'];
        $args['redirect'] = !$args['redirect'] ? url() : $args['redirect'];
        $args['msg'] = !$args['msg'] ? str("Login") : $args['msg'];

        $args['redirect_again_to'] = !$redirect_again_to ?  url() : $redirect_again_to;
